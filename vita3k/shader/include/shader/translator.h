...
public:
    ...
    explicit USSETranslatorVisitor(USSERecompiler &_recompiler, const SceGxmProgram &program, const FeatureState &features, const uint64_t &_instr,
