    ...
    while (!restore_infos.empty()) {
        ...
        case ShaderVariableVec4Info::DIRTY_TYPE_S16: {
            ...
            if (res_info.decl & mask_check_other) {
                if (res_info.original_type == ShaderVariableVec4Info::DIRTY_TYPE_S16) {
                    writer.add_to_current_body(fmt::format("u16{}{}.{} = uvec2(i16{}{}.{});", prefix, index_16, swizzle_f16, prefix, index_16, swizzle_f16));
                } else {
                    writer.add_to_current_body(fmt::format("i16{}{}.{} = ivec2(u16{}{}.{});", prefix, index_16, swizzle_f16, prefix, index_16, swizzle_f16));
                }
            }
