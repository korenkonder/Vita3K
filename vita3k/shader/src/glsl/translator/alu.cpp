...
bool USSETranslatorVisitorGLSL::vcomp(
    ...
    const uint32_t nb_components = std::popcount(write_mask);
    ...
    case Opcode::VEXP: {
        ...
        result = fmt::format("isnan({}) ? 1.0 : exp({})", result, result);
        break;
    }
    ...
    if (nb_components > 1) {
        result = fmt::format("vec{}({})", nb_components, result);
    }
...
bool USSETranslatorVisitorGLSL::sop3(Imm2 pred,
    ...
    Imm7 src1n,
    Imm7 src2n) {
    static auto selector_zero = [](const std::string src0_color, const std::string src1_color, const std::string src2_color, const std::string src0_alpha, const std::string src1_alpha, const std::string src2_alpha, const bool is_color) {
        return is_color ? "uvec3(0)" : "0";
    };

    static auto selector_src0_color = [](const std::string src0_color, const std::string src1_color, const std::string src2_color, const std::string src0_alpha, const std::string src1_alpha, const std::string src2_alpha, const bool is_color) {
        return src0_color;
    };

    static auto selector_src1_color = [](const std::string src0_color, const std::string src1_color, const std::string src2_color, const std::string src0_alpha, const std::string src1_alpha, const std::string src2_alpha, const bool is_color) {
        return src1_color;
    };

    static auto selector_src2_color = [](const std::string src0_color, const std::string src1_color, const std::string src2_color, const std::string src0_alpha, const std::string src1_alpha, const std::string src2_alpha, const bool is_color) {
        return src2_color;
    };

    static auto selector_src0_alpha = [](const std::string src0_color, const std::string src1_color, const std::string src2_color, const std::string src0_alpha, const std::string src1_alpha, const std::string src2_alpha, const bool is_color) {
        if (is_color) {
            return fmt::format("uvec3({})", src0_alpha);
        }

        return src0_alpha;
    };

    static auto selector_src1_alpha = [](const std::string src0_color, const std::string src1_color, const std::string src2_color, const std::string src0_alpha, const std::string src1_alpha, const std::string src2_alpha, const bool is_color) {
        if (is_color) {
            return fmt::format("uvec3({})", src1_alpha);
        }
    ...
    static auto selector_src2_alpha = [](const std::string src0_color, const std::string src1_color, const std::string src2_color, const std::string src0_alpha, const std::string src1_alpha, const std::string src2_alpha, const bool is_color) {
        if (is_color) {
            return fmt::format("uvec3({})", src2_alpha);
        }
    ...
    using SelectorFunc = std::function<std::string(const std::string, const std::string, const std::string, const std::string, const std::string, const std::string, bool)>;
    ...
    std::string src0_color = variables.load(inst.opr.src0, 0b0111, 0);
    std::string src1_color = variables.load(inst.opr.src1, 0b0111, 0);
    std::string src2_color = variables.load(inst.opr.src2, 0b0111, 0);
    std::string src0_alpha = variables.load(inst.opr.src0, 0b1000, 0);
    std::string src1_alpha = variables.load(inst.opr.src1, 0b1000, 0);
    std::string src2_alpha = variables.load(inst.opr.src2, 0b1000, 0);

    src0_color = variables.convert_to_float(src0_color, 3, DataType::UINT8, true);
    src1_color = variables.convert_to_float(src1_color, 3, DataType::UINT8, true);
    src2_color = variables.convert_to_float(src2_color, 3, DataType::UINT8, true);
    src0_alpha = variables.convert_to_float(src0_alpha, 1, DataType::UINT8, true);
    src1_alpha = variables.convert_to_float(src1_alpha, 1, DataType::UINT8, true);
    src2_alpha = variables.convert_to_float(src2_alpha, 1, DataType::UINT8, true);

    // Apply color selector
    std::string factored_rgb_lhs = color_selector_1_func(src0_color, src1_color, src2_color, src0_alpha, src1_alpha, src2_alpha, true);
    std::string factored_rgb_rhs = color_selector_2_func(src0_color, src1_color, src2_color, src0_alpha, src1_alpha, src2_alpha, true);

    std::string factored_a_lhs = alpha_selector_1_func(src0_color, src1_color, src2_color, src0_alpha, src1_alpha, src2_alpha, false);
    std::string factored_a_rhs = alpha_selector_2_func(src0_color, src1_color, src2_color, src0_alpha, src1_alpha, src2_alpha, false);
    ...
    apply_complement_modifiers(factored_a_rhs, cmod2, false);
    ...
    // Final result. Do binary operation and then store
    variables.store(inst.opr.dest, color_res, 0b0111, 0);
    variables.store(inst.opr.dest, alpha_res, 0b1000, 0);
...
bool USSETranslatorVisitorGLSL::vdual(
    ...
    const int num_comp_op2 = dest_mask_to_comp_count(decoded_source_mask_2);
    std::string temp_load = variables.load(decoded_inst_2.opr.src0, decoded_source_mask_2, 0);

    src0_op2 = fmt::format("temp{}", num_comp_op2);
    ...
    if (num_src_needed > 1) {
        ...
        src1_op2 = fmt::format("temp{}_1", num_comp_op2);
    ...
    if (num_src_needed > 2) {
        ...
        src2_op2 = fmt::format("temp{}_2", num_comp_op2);
    ...
    auto do_dual_op = [&](Opcode op, const std::string &src0, const std::string &src1, const std::string &src2, const Imm4 write_mask_source) -> std::string {
        ...
        case Opcode::FEXP: {
            ...
            if (dest_mask_to_comp_count(write_mask_source) > 1) {
                return fmt::format("mix(exp({}), vec{}(1.0), isnan({}))", src0, dest_mask_to_comp_count(write_mask_source), src0);
            }

            return fmt::format("isnan({}) ? 1.0 : exp({})", src0, src0);
        }
        case Opcode::FLOG: {
        ...
        case Opcode::FSUBFLR: {
            // result = src0 - Floor(src1)
            // If two source are identical, let's use the fractional function
            if (src0 == src1) {
                return fmt::format("fract({})", src0);
            } else {
                // We need to floor source 1, then subtract source 0 with the floored source 1.
                return fmt::format("{} - floor({})", src0, src1);
            }
            break;
        }
        default:
