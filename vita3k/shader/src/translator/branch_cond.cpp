...
bool USSETranslatorVisitor::vtstmsk(
    ...
    decoded_inst.opr.src1 = decode_src12(decoded_inst.opr.src1, src1_n, src1_bank, src1_ext, use_double_reg, reg_bits, m_second_program);
    decoded_inst.opr.src2 = decode_src12(decoded_inst.opr.src2, src2_n, src2_bank, src2_ext, use_double_reg, reg_bits, m_second_program);
    decoded_inst.opr.dest = decode_dest(decoded_inst.opr.dest, dest_n, dest_bank, dest_ext, use_double_reg, reg_bits, m_second_program);

    decoded_inst.opr.src1.type = load_data_type;
    decoded_inst.opr.src2.type = load_data_type;
    decoded_inst.opr.dest.type = load_data_type;

    decoded_inst.opr.src1.swizzle = SWIZZLE_CHANNEL_4_DEFAULT;
    decoded_inst.opr.src2.swizzle = (alu_sel == 0 && src2_vscomp) ? (Swizzle4 SWIZZLE_CHANNEL_4(X, X, X, X)) : (Swizzle4 SWIZZLE_CHANNEL_4_DEFAULT);
