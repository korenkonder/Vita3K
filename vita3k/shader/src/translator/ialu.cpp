...
bool USSETranslatorVisitor::vbw(
    ...
    decoded_inst.opr.src1.type = type;
    decoded_inst.opr.src2.type = type;
    decoded_inst.opr.dest.type = type;
    ...
    LOG_DISASM("{:016x}: {}{}{} {} {} {}", m_instr, disasm::e_predicate_str(pred), disasm::opcode_str(decoded_inst.opcode), bitwise_partial ? "16" : "",
