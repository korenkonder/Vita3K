...
bool USSETranslatorVisitor::vmad(
    ...
    Imm4 src1_swiz,
    Imm6 src1_n) {
    decoded_inst.opcode = Opcode::VMAD;
...
bool USSETranslatorVisitor::vmad2(
    ...
    // Log the instruction
    LOG_DISASM("{:016x}: {}{}2 {} {} {} {}", m_instr, disasm::e_predicate_str(static_cast<ExtPredicate>(pred)), disasm::opcode_str(op), disasm::operand_to_str(decoded_inst.opr.dest, decoded_dest_mask),
        disasm::operand_to_str(decoded_inst.opr.src0, decoded_dest_mask), disasm::operand_to_str(decoded_inst.opr.src1, decoded_dest_mask), disasm::operand_to_str(decoded_inst.opr.src2, decoded_dest_mask));
...
bool USSETranslatorVisitor::vdp(
    ...
    Imm3 src1_swiz_x,
    Imm6 src1_n) {
    decoded_inst.opcode = Opcode::VDP;
