...
bool USSETranslatorVisitor::smp(
    ...
    LOG_DISASM("{:016x}: {}SMP{}d.{}.{}{} {} {} {} {}", m_instr, disasm::e_predicate_str(pred), dim, disasm::data_type_str(decoded_inst.opr.dest.type), disasm::data_type_str(decoded_inst.opr.src0.type), additional_info,
