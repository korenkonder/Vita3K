...
bool USSETranslatorVisitorSpirv::i32mad(
    ...
    spv::Id vsrc0 = load(decoded_inst.opr.src0, decoded_source_mask, src0_repeat_offset);
    spv::Id vsrc1 = load(decoded_inst.opr.src1, decoded_source_mask_2, src1_repeat_offset);
    spv::Id vsrc2 = load(decoded_inst.opr.src2, decoded_source_mask_3, src2_repeat_offset);
    ...
    store(decoded_inst.opr.dest, add_result, 0b1, dest_repeat_offset);
